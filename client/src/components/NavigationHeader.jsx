...
import UserButton from "../app/Editor/components/UserButton";
import { Blocks, Codepen, Sparkles } from "lucide-react";
import { Link } from "react-router-dom";

const NavigationHeader = () => {
    const { isAuthenticated} = useAuth0(); // Replace with actual authentication logic
  return (
        ...
        <div className="relative h-16 flex items-center justify-between">
          <div className="flex items-center gap-8">
            ...
            >
              ...
              />
              <Codepen className="w-4 h-4 relative z-10 group-hover:rotate-3 transition-transform" />
