  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className="w-42 group relative flex items-center justify-between gap-2 px-3 py-2.5 bg-[#1e1e2e]/80 hover:bg-[#262637] 
        rounded-lg transition-all duration-200 border border-gray-800/50 hover:border-gray-700 cursor-pointer"
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-gray-300 min-w-[80px] text-left group-hover:text-white transition-colors">
            {currentTheme?.label}
          </span>
        </div>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 w-56  bg-[#1e1e2e]/95 
          ...
          >
            ...
            {THEMES.map((t, index) => (
              <motion.button
                ...
                className={`
                relative group w-full flex items-center gap-3 px-3 py-2.5 hover:bg-[#262637] transition-all duration-200 cursor-pointer
                ${
                  theme === t.id
              ...
              group-hover:opacity-100 transition-opacity"
                ...
                ${
                  theme === t.id
                    ? "bg-blue-500/10 hover:bg-blue-500/40 text-blue-400 hover:text-blue-500"
              ...
              `}
                ...
                {/* label */}
                <span
                  className={`flex-1 text-left transition-colors text-sm
                    ${
                      theme === t.id
                ...
                {theme === t.id && (
                  <motion.div
                    className="absolute inset-0 border-2 border-blue-500/30 hover:border-blue-500/50 rounded-lg"
