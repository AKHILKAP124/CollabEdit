...
import { updateLanguage } from "../../../redux/EditorSlice";
...
function LanguageSelector({ hasAccess }) {
  ...
  const handleLanguageSelect = (langId) => {
    if (!hasAccess && langId !== "javascript") return navigate("/purchase");

    dispatch(updateLanguage(langId));
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className={`group relative flex items-center gap-2 px-3 py-2.5 bg-[#1e1e2e]/80 
      ...
      >
        ...
        <span className="text-sm text-gray-200 min-w-[80px] text-left group-hover:text-white transition-colors">
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        className={`
                         relative size-7 rounded-lg p-1.5 group-hover:scale-110 transition-transform
                         ${
                           language === lang.id
                             ? "bg-blue-500/10"
                             : "bg-gray-800/50"
