...
function SnippetCard({ snippet, fetchSnippets }) {
  ...
  const handleDelete = async () => {
    ...
    try {
      await axios.delete(`/api/v1/snippet/delete/${snippet._id}`).then(() => {
        fetchSnippets(); // Refresh snippets after deletion
